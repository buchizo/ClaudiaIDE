...
namespace ClaudiaIDE.Localized {
    ...
    public class ResLocalized {
        ...
        /// <summary>
        ///   Image blur radius に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   Apply Gaussian Blur on background images. This option does not support videos and GIFs. WebApi slideshow may have more delay, but it still works If this value set to zero, no blur. (value within the range of 0 &lt;= {image the smaller of x and y size / 2 - 1} ). に類似しているローカライズされた文字列を検索します。
        /// </summary>
